...
namespace xayah::cloth {
    ...
    void ForceAssemblyOperator::forward(cuda::Resource& resource, const DeviceTopology& topology, const Configuration& configuration, const State& state, const Control& control, const Parameters& parameters, Forces& forces) const {
    ...
    void ForceAssemblyOperator::jvp(cuda::Resource& resource, const DeviceTopology& topology, const Configuration& configuration, const State& state, const Parameters& parameters, const StateTangent& state_tangent, const ControlTangent& control_tangent, const ParameterTangent& parameter_tangent, ForceTangent& force_tangent) const {
    ...
    void ForceAssemblyOperator::vjp(cuda::Resource& resource, const DeviceTopology& topology, const Configuration& configuration, const State& state, const Parameters& parameters, const ForceAdjoint& force_adjoint, StateAdjoint& state_adjoint, ControlAdjoint& control_adjoint, ParameterAdjoint& parameter_adjoint) const {
    ...
    void SemiImplicitEulerOperator::forward(cuda::Resource& resource, const Configuration& configuration, const State& state, const Parameters& parameters, const Forces& forces, State& integrated_state) const {
    ...
    void SemiImplicitEulerOperator::jvp(cuda::Resource& resource, const Configuration& configuration, const Parameters& parameters, const Forces& forces, const StateTangent& state_tangent, const ParameterTangent& parameter_tangent, const ForceTangent& force_tangent, StateTangent& integrated_state_tangent) const {
    ...
    void SemiImplicitEulerOperator::vjp(cuda::Resource& resource, const Configuration& configuration, const Parameters& parameters, const Forces& forces, const StateAdjoint& integrated_state_adjoint, StateAdjoint& state_adjoint, ForceAdjoint& force_adjoint, ParameterAdjoint& parameter_adjoint) const {
    ...
    void FixedConstraintOperator::forward(cuda::Resource& resource, const DeviceTopology& topology, const State& state, State& constrained_state) const {
    ...
    void FixedConstraintOperator::jvp(cuda::Resource& resource, const DeviceTopology& topology, const StateTangent& state_tangent, StateTangent& constrained_state_tangent) const {
    ...
    void FixedConstraintOperator::vjp(cuda::Resource& resource, const DeviceTopology& topology, const StateAdjoint& constrained_state_adjoint, StateAdjoint& state_adjoint) const {
